...
class DesktopPet(QWidget):
    def __init__(self, cfg, util, parent=None, **kwargs):
        ...
        self.DWindowThread = ThreadForDwindow(cfg)
        ...
        self.movie = QMovie(self.cfg.idle)
        ...
        duration = util.find_duration(self.cfg.idle)
            ...
            if x > monitorwidth // 2:  # right
                while x <= monitorwidth + 100:
                    ...
                    if re.search(".gif$", self.cfg.frame) != None:
                        self.timer.setInterval(self.util.find_duration(self.cfg.idle))
